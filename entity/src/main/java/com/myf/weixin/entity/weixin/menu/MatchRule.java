...
public class MatchRule {
    private int tag_id;//用户标签的id，可通过用户标签管理接口获取
    private int sex;//性别：男（1）女（2），不填则不做匹配
    private int client_platform_type;//客户端版本，当前只具体到系统型号：IOS(1), Android(2),Others(3)，不填则不做匹配
